...
# Prueba de chi-cuadrado para ver si hay diferencias en la cantidad de proteinas hipotéticas dada por el tamaño
...
# test ANOVA para comparar tamaños de los smORFs a través de las distintas categorías de conservación
...
plt.ylabel('Longitud')
plt.xticks(rotation=45)
plt.savefig("boxplot_ANOVA" , bbox_inches= "tight")
